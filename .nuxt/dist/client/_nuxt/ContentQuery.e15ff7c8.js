...
const Q = g({
    ...
    async setup(u) {
      const {
        ...
        y = !b().public.content.experimental.advanceQuery;
      A(
        () => u,
        () => n(),
        { deep: !0 },
      ...
      const i = (e) =>
          y
            ? e != null && e.surround
              ? e.surround
              : (e != null && e._id) || Array.isArray(e)
              ? e
              : e == null
              ? void 0
              : e.result
            : e.result,
        { data: v, refresh: n } = await _(`content-query-${k(u)}`, () => {
          let e;
          return (
            t.value ? (e = m(t.value)) : (e = m()),
            r.value && (e = e.only(r.value)),
            o.value && (e = e.without(o.value)),
            a.value && (e = e.where(a.value)),
            l.value && (e = e.sort(l.value)),
            d.value && (e = e.limit(d.value)),
            f.value && (e = e.skip(f.value)),
            s.value && (e = e.where({ _locale: s.value })),
            h.value === 'one'
              ? e.findOne().then(i)
              : h.value === 'surround'
              ? t.value
                ? y
                  ...
                  : e.withSurround(t.value).findOne().then(i)
                : (console.warn(
      ...
      return { isPartial: p, data: v, refresh: n };
    },
    render(u) {
      var c;
      const t = N(),
      ...
      if (n.find === 'one') {
        if (!r && t != null && t['not-found'])
          return t['not-found']({ props: n, ...this.$attrs });
        if (
          t != null &&
          t.empty &&
          (r == null ? void 0 : r._type) === 'markdown' &&
          !((c = r == null ? void 0 : r.body) != null && c.children.length)
        )
          return t.empty({ props: n, ...this.$attrs });
      ...
      return t != null && t.default
        ...
        : ((w, q) =>
            ...
            ))('default', { data: r, props: n, isPartial: a });
    },
  }),
  x = Q;
export { x as default };
