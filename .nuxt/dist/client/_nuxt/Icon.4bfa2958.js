...
import { u as et } from './state.704f78e9.js';
import { _ as tt } from './_plugin-vue_export-helper.c27b6911.js';
const je = Object.freeze({ left: 0, top: 0, width: 16, height: 16 }),
  Te = Object.freeze({ rotate: 0, vFlip: !1, hFlip: !1 }),
  Y = Object.freeze({ ...je, ...Te });
Object.freeze({ ...Y, body: '', hidden: !1 });
({ ...je });
const Pe = Object.freeze({ width: null, height: null }),
  Oe = Object.freeze({ ...Pe, ...Te });
function nt(e, t) {
  const n = { ...e };
  for (const r in t) {
    const o = t[r],
...
function at(e, t) {
  ...
  [n, r].forEach((d) => {
    ...
    switch ((b < 0 && (b -= Math.floor(b / 4) * 4), (b = b % 4), b)) {
      case 1:
        (v = o.height / 2 + o.top),
          h.unshift('rotate(90 ' + v.toString() + ' ' + v.toString() + ')');
        break;
      case 2:
        h.unshift(
          'rotate(180 ' +
  ...
  let u, f;
  i === null
    ? ((f = c === null ? '1em' : c === 'auto' ? a : c), (u = ae(f, l / a)))
    : ((u = i === 'auto' ? l : i),
      (f = c === null ? ae(u, a / l) : c === 'auto' ? a : c));
  const g = {},
    y = (d, h) => {
      lt(h) || (g[d] = h.toString());
    };
...
function pt(e, t = ft) {
  const n = [];
  let r;
  for (; (r = ut.exec(e)); ) n.push(r[1]);
  if (!n.length) return e;
  const o = 'suffix' + ((Math.random() * 16777216) | Date.now()).toString(16);
  return (
    n.forEach((s) => {
      const i = typeof t == 'function' ? t(s) : t + (dt++).toString(),
        c = s.replace(/[.*+?^${}()|[\]\\]/g, '\\$&');
      e = e.replace(
        new RegExp('([#;"])(' + c + ')([")]|\\.[a-z])', 'g'),
        '$1' + i + o + '$3',
...
function mt(e) {
  return 'data:image/svg+xml,' + gt(e);
}
function yt(e) {
  return 'url("' + mt(e) + '")';
}
const ue = { ...Oe, inline: !1 },
  bt = {
  ...
  H = { backgroundColor: 'currentColor' },
  Ee = { backgroundColor: 'transparent' },
  fe = { Image: 'var(--svg)', Repeat: 'no-repeat', Size: '100% 100%' },
  de = { webkitMask: H, mask: H, background: Ee };
for (const e in de) {
  const t = de[e];
  for (const n in fe) t[e + n] = fe[n];
}
const _ = {};
...
const wt = (e, t) => {
    ...
    if ((n.inline && (s.verticalAlign = '-0.125em'), o === 'svg')) {
      (r.style = { ...s, ...c }), Object.assign(r, a);
      let h = 0,
        p = t.id;
      return (
        typeof p == 'string' && (p = p.replace(/-/g, '_')),
        (r.innerHTML = pt(l.body, p ? () => p + 'ID' + h++ : 'iconifyVue')),
        se('svg', r)
      );
    }
    const { body: u, width: f, height: g } = e,
      y = o === 'mask' || (o === 'bg' ? !1 : u.indexOf('currentColor') !== -1),
      d = ht(u, { ...a, width: f + '', height: g + '' });
    return (
      (r.style = {
        ...s,
        '--svg': yt(d),
  ...
  It = ke({
    ...
    render() {
      const e = this.$attrs,
        t = e.icon,
        n = typeof t == 'string' ? xt[t] : typeof t == 'object' ? t : null;
  ...
  N = (e, t, n, r = '') => {
    ...
    if (o.length > 1) {
      const c = o.pop(),
        l = o.pop(),
        a = { provider: o.length > 0 ? o[0] : r, prefix: l, name: c };
      return t && !z(a) ? null : a;
    }
    const s = o[0],
      i = s.split('-');
  ...
  z = (e, t) =>
    e
      ...
      : !1,
  Fe = Object.freeze({ left: 0, top: 0, width: 16, height: 16 }),
  $ = Object.freeze({ rotate: 0, vFlip: !1, hFlip: !1 }),
  X = Object.freeze({ ...Fe, ...$ }),
  V = Object.freeze({ ...X, body: '', hidden: !1 });
function St(e, t) {
  const n = {};
...
function Ae(e, t) {
  ...
  for (const o in r) {
    const s = r[o];
    s && (t(o, kt(e, o, s)), n.push(o));
  }
  return n;
}
const jt = { provider: '', aliases: {}, not_found: {}, ...Fe };
function B(e, t) {
...
function Me(e) {
  ...
  for (const o in n) {
    const s = n[o];
    if (!o.match(T) || typeof s.body != 'string' || !B(s, V)) return null;
  }
  const r = t.aliases || Object.create(null);
  for (const o in r) {
    const s = r[o],
      i = s.parent;
    if (!o.match(T) || typeof i != 'string' || (!n[i] && !r[i]) || !B(s, V))
      return null;
  }
  return t;
}
...
function S(e, t) {
  const n = ge[e] || (ge[e] = Object.create(null));
...
function Ot(e) {
  const t = typeof e == 'string' ? N(e, !0, P) : e;
  if (t) {
    const n = S(t.provider, t.prefix),
      r = t.name;
...
function Ft(e, t) {
  ...
  const n = e.prefix;
  if (!z({ provider: t, prefix: n, name: 'a' })) return !1;
  const r = S(t, n);
  return !!Z(r, e);
}
const At = Object.freeze({ width: null, height: null }),
  Mt = Object.freeze({ ...At, ...$ });
...
const te = Object.create(null),
  ...
  L = [];
for (; j.length > 0; )
  j.length === 1 || Math.random() > 0.5 ? L.push(j.shift()) : L.push(j.pop());
te[''] = ee({ resources: ['https://api.iconify.design'].concat(L) });
function zt(e, t) {
  const n = ee(t);
      ...
      t.forEach((s) => {
        ...
        (i.pending = i.pending.filter((l) => {
          ...
          if (e.icons[a]) i.loaded.push({ provider: r, prefix: o, name: a });
            ...
            i.missing.push({ provider: r, prefix: o, name: a });
          else return (n = !0), !0;
          return !1;
        })),
          i.pending.length !== c &&
...
function Kt(e, t = !0, n = !1) {
  ...
  return (
    e.forEach((o) => {
      const s = typeof o == 'string' ? N(o, t, n) : o;
      s && r.push(s);
    }),
    r
  );
...
function Jt(e, t, n, r) {
  ...
  if (e.random) {
    ...
    for (i = []; m.length > 1; ) {
      ...
      i.push(m[w]), (m = m.slice(0, w).concat(m.slice(w + 1)));
    }
    i = i.concat(m);
  ...
  function p(m, w) {
    w && (y = []), typeof m == 'function' && y.push(m);
  }
  function x() {
    return {
      startTime: c,
  ...
  function Qe(m, w, C) {
    ...
    if (E) {
      (u = C), g.length || (i.length ? R() : b());
      return;
    }
    if ((d(), v(), !e.random)) {
      const I = e.resources.indexOf(m.resource);
  ...
  function R() {
    ...
    g.push(w), a++, (f = setTimeout(R, e.rotate)), n(m, t, w.callback);
  }
...
function Yt(e, t, n) {
  ...
  return !r || !o ? (n(void 0, 424), ye) : r.query(t, o, n)().abort;
}
const be = 'iconify2',
  O = 'iconify',
  $e = O + '-count',
...
function J(e, t) {
  return oe(e, $e, t.toString());
}
function W(e) {
  return parseInt(G(e, $e)) || 0;
}
const D = { local: !0, session: !0 },
  De = { local: new Set(), session: new Set() };
let re = !1;
function Zt(e) {
  re = e;
}
...
function Be(e, t) {
  ...
  if (r !== be) {
    if (r) {
      const c = W(n);
      for (let l = 0; l < c; l++) we(n, O + l.toString());
    }
    oe(n, ve, be), J(n, 0);
    return;
  }
  const o = Math.floor(Date.now() / Ne) - Xt,
    s = (c) => {
...
function tn(e, t) {
  ...
  function n(r) {
    let o;
    if (!D[r] || !(o = Re(r))) return;
    const s = De[r];
    let i;
    if (s.size) s.delete((i = Array.from(s).shift()));
    else if (((i = W(o)), !J(o, i + 1))) return;
    const c = {
      cached: Math.floor(Date.now() / Ne),
      provider: e.provider,
      data: t,
    };
    return oe(o, O + i.toString(), JSON.stringify(c));
  }
  (t.lastModified && !en(e, t.lastModified)) ||
...
const rn = (e, t) => {
    ...
    if (!r.pending.length) {
      ...
      return (
        t &&
          setTimeout(() => {
            l && t(r.loaded, r.missing, r.pending, xe);
          }),
        () => {
          l = !1;
        }
    ...
    return (
      r.pending.forEach((l) => {
        ...
        if (u === c && a === i) return;
        (i = a), (c = u), s.push(S(a, u));
        const f = o[a] || (o[a] = Object.create(null));
        f[u] || (f[u] = []);
      }),
      r.pending.forEach((l) => {
        const { provider: a, prefix: u, name: f } = l,
          g = S(a, u),
          y = g.pendingIcons || (g.pendingIcons = new Set());
        y.has(f) || (y.add(f), o[a][u].push(f));
      }),
      s.forEach((l) => {
        const { provider: a, prefix: u } = l;
        o[a][u].length && on(l, o[a][u]);
      }),
      t ? Ut(t, r, s) : xe
    );
  },
  sn = (e) =>
    new Promise((t, n) => {
      const r = typeof e == 'string' ? N(e, !0) : e;
      if (!r) {
        n(e);
        return;
      }
...
({ ...Mt });
const Ie = { backgroundColor: 'currentColor' },
  cn = { backgroundColor: 'transparent' },
  Se = { Image: 'var(--svg)', Repeat: 'no-repeat', Size: '100% 100%' },
  Ce = { webkitMask: Ie, mask: Ie, background: cn };
for (const e in Ce) {
  const t = Ce[e];
  for (const n in Se) t[e + n] = Se[n];
}
const Q = {};
['horizontal', 'vertical'].forEach((e) => {
  const t = e.slice(0, 1) + 'Flip';
  ...
  async setup(e) {
    ...
    const r = Ze(),
      ...
      l = k(() => {
        var d;
        return (
          (((d = o.nuxtIcon) == null ? void 0 : d.aliases) || {})[s.name] ||
          s.name
        ).replace(/^i-/, '');
      }),
      a = k(() => {
        var d;
        return (d = i.value) == null ? void 0 : d[l.value];
      }),
      u = k(() => r.vueApp.component(l.value)),
      f = k(() => {
        var h, p, x;
        if (
          !s.size &&
          typeof ((h = o.nuxtIcon) == null ? void 0 : h.size) == 'boolean' &&
          !((p = o.nuxtIcon) != null && p.size)
        )
          return;
        const d =
          s.size || ((x = o.nuxtIcon) == null ? void 0 : x.size) || '1em';
        return String(Number(d)) === d ? `${d}px` : d;
      }),
      g = k(() => {
        var d;
        return (
          ((d = o == null ? void 0 : o.nuxtIcon) == null ? void 0 : d.class) ??
          'icon'
        );
      });
    async function y() {
      var d;
      u.value ||
        ((d = i.value) != null && d[l.value]) ||
        ((c.value = !0),
        (i.value[l.value] = await sn(l.value).catch(() => {})),
        (c.value = !1));
    }
    return (
      Ue(() => l.value, y),
      !u.value && (([t, n] = Ke(() => y())), (t = await t), n()),
      (d, h) =>
        c.value
          ? (F(),
            ie(
              'span',
              {
                key: 0,
                class: A(g.value),
                style: ce({ width: f.value, height: f.value }),
              },
              null,
              6,
            ))
          ...
          ? (F(),
            le(
              Je(u.value),
              { key: 2, class: A(g.value), width: f.value, height: f.value },
              null,
              8,
              ['class', 'width', 'height'],
            ))
          : (F(),
            ie(
              ...
              [We(d.$slots, 'default', {}, () => [Ye(Xe(e.name), 1)], !0)],
              6,
            ))
    );
  },
});
const dn = tt(ln, [['__scopeId', 'data-v-9c34c54e']]);
