import { _ as _sfc_main$4 } from './FormattedDate-2afc3c99.js';
import {
  defineComponent,
  mergeProps,
  useSSRContext,
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      _push(
        ...
        )}>${ssrInterpolate(_ctx.viewCount)} views </div>`,
      );
    };
  },
});
...
_sfc_main$3.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add(
    'components/blog/PostViewCount.vue',
  );
...
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(
        `<span class="relative z-10 rounded-full bg-neutral-700 px-3 py-1.5 font-medium text-neutral-300">${ssrInterpolate(
          _ctx.category,
        )}</span>`,
      );
      _push(
        ssrRenderComponent(
          _component_BlogPostViewCount,
          { 'view-count': _ctx.viewCount },
          null,
          _parent,
        ),
      );
        ...
        ssrRenderComponent(
          ...
          { to: _ctx.slug },
          {
            default: withCtx((_, _push2, _parent2, _scopeId) => {
              if (_push2) {
                _push2(
                  `<div class="group relative"${_scopeId}><h3 class="mt-3 font-roboto-mono text-lg leading-6 tracking-tighter text-neutral-300 group-hover:text-neutral-400"${_scopeId}><span class="absolute inset-0"${_scopeId}></span> ${ssrInterpolate(
                    _ctx.title,
                  )}</h3><p class="mt-5 line-clamp-3 text-sm leading-6 text-neutral-400"${_scopeId}>${ssrInterpolate(
                    _ctx.description,
                  )}</p></div>`,
                );
              } else {
                return [
                  createVNode('div', { class: 'group relative' }, [
                    ...
                    createVNode(
                      ...
                      {
                        class:
                          'mt-5 line-clamp-3 text-sm leading-6 text-neutral-400',
                      },
...
_sfc_main$2.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add(
    'components/blog/PostPreview.vue',
  );
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(
        `<div${ssrRenderAttrs(
          mergeProps({ class: 'mx-auto' }, _attrs),
        )}><div class="mx-auto mt-10 grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 border-t border-neutral-800 pt-10 sm:mt-16 sm:grid-cols-2 sm:pt-16 lg:mx-0 lg:max-w-none lg:grid-cols-3"><!--[-->`,
      );
      ssrRenderList(unref(previewPosts), (post) => {
        _push(
          ssrRenderComponent(
            _component_BlogPostPreview,
            {
              key: post.slug,
              slug: post.slug,
...
_sfc_main$1.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add(
    'components/blog/PostPreviews.vue',
  );
...
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add(
    'components/blog/PostsLoading.vue',
  );
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const __nuxt_component_4 = /* @__PURE__ */ _export_sfc(_sfc_main, [
  ['ssrRender', _sfc_ssrRender],
]);
export { _sfc_main$1 as _, __nuxt_component_4 as a };
//# sourceMappingURL=PostsLoading-bc3655ac.js.map
