import { _ as _sfc_main$5 } from './SectionHeader-2f2bda11.js';
import {
  mergeProps,
  useSSRContext,
  withCtx,
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  ...
  _push(
    `<div${ssrRenderAttrs(
      mergeProps({ class: 'flex flex-row items-center gap-x-4' }, _attrs),
    )}><div class="prose mx-auto inline-flex max-w-2xl flex-col text-sm leading-6 text-neutral-400"><p class="mt-6 text-justify"> Hi, I&#39;m Joey. I&#39;m a `,
  );
  _push(
    ssrRenderComponent(
      _component_InlineBold,
      null,
      {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            return [createTextVNode('Senior Software Engineer')];
          }
        }),
        _: 1,
      },
...
_sfc_main$3.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add(
    'components/home/IntroSection.vue',
  );
          ...
          ),
          {
            default: withCtx((_, _push2, _parent2, _scopeId) => {
              if (_push2) {
                ...
                _push2(` ${ssrInterpolate(_ctx.display)} `);
                _push2(
                  ssrRenderComponent(
                    _component_Icon,
                    {
                ...
                return [
                  ...
                  createTextVNode(' ' + toDisplayString(_ctx.display) + ' ', 1),
...
_sfc_main$2.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add(
    'components/home/SocialButton.vue',
  );
...
_sfc_main$1.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add(
    'components/home/SocialButtons.vue',
  );
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_HomeIntroSection = __nuxt_component_1;
      const _component_HomeSocialButtons = _sfc_main$1;
      const _component_BlogPostPreviews = _sfc_main$6;
      ...
      _push(
        ssrRenderComponent(_component_HomeIntroSection, null, null, _parent),
      );
      _push(
        ssrRenderComponent(_component_HomeSocialButtons, null, null, _parent),
      );
...
//# sourceMappingURL=index-4bd8f42c.js.map
