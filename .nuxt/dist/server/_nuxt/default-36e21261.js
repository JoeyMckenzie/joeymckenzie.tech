import { _ as _sfc_main$9 } from './HtmlTag-1d571bc3.js';
import { _ as __nuxt_component_0$1 } from './nuxt-link-e4ece057.js';
import {
  defineComponent,
  mergeProps,
  withCtx,
          ...
          ssrRenderComponent(
            ...
            },
            {
              default: withCtx((_, _push2, _parent2, _scopeId) => {
                if (_push2) {
                  _push2(
                    `<span class="sr-only"${_scopeId}>${ssrInterpolate(
                      social.display,
                    )}</span>`,
                  );
                  _push2(
                  ...
                  return [
                    createVNode(
                      'span',
                      { class: 'sr-only' },
                      toDisplayString(social.display),
                      1,
                    ),
                    createVNode(
                      _component_Icon,
...
const _sfc_main$5 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      _push(
        `<div${ssrRenderAttrs(
          mergeProps({ class: 'flex flex-col space-y-1' }, _attrs),
        )}><div class="flex flex-row items-center justify-center space-x-2">`,
      );
      ssrRenderSlot(_ctx.$slots, 'default', {}, null, _push, _parent);
      _push(
        `<div class="flex flex-col"><h4 class="text-xs text-neutral-500">${ssrInterpolate(
          __props.text,
        )}</h4></div></div></div>`,
      );
    };
...
_sfc_main$5.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add(
    'components/spotify/NotCurrentlyListening.vue',
  );
...
async function _imageMeta(url) {
  {
    ...
    if (!metadata) {
      throw new Error(
        `No metadata could be extracted from the image \`${url}\`.`,
      );
    }
...
function resolveImage(ctx, input, options) {
  ...
  if (typeof input !== 'string' || input === '') {
    throw new TypeError(
      `input must be a string (received ${typeof input}: ${JSON.stringify(
        input,
      )})`,
    );
  }
  ...
  const { provider, defaults } = getProvider(
    ctx,
    options.provider || ctx.options.provider,
  );
...
function finaliseSizeVariants(sizeVariants) {
  ...
  for (let i = 0; i < sizeVariants.length; i++) {
    sizeVariants[i].media =
      ((_a = sizeVariants[i + 1]) == null ? void 0 : _a.media) || '';
  }
}
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(
        ...
        )}><h2 class="inline-flex justify-center font-ubuntu text-xs text-neutral-400"> Now listening </h2><div class="flex flex-row items-center justify-center space-x-2">`,
      );
      ssrRenderSlot(_ctx.$slots, 'default', {}, null, _push, _parent);
      _push(
        ssrRenderComponent(
      ...
      _push(
        `<div class="flex max-w-[16rem] flex-col"><h4 class="line-clamp-1 overflow-hidden text-ellipsis text-xs font-semibold text-neutral-300">${ssrInterpolate(
          _ctx.response.trackTitle,
        )}</h4><p class="text-xs text-neutral-400">${ssrInterpolate(
          _ctx.response.artist,
        )}</p></div></div></a>`,
      );
    };
  },
...
_sfc_main$4.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add(
    'components/spotify/CurrentlyPlaying.vue',
  );
  ...
  async setup(__props) {
    ...
    const { data, pending } =
      (([__temp, __restore] = withAsyncContext(() =>
        useFetch('/api/spotify', '$jreJfgp754'),
      )),
      (__temp = await __temp),
      __restore(),
      __temp);
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (unref(pending)) {
        ...
        _push(
          ssrRenderComponent(
            _component_SpotifyNotCurrentlyListening,
            { text: 'Loading...' },
            {
              default: withCtx((_, _push2, _parent2, _scopeId) => {
                if (_push2) {
        ...
        !unref(pending) &&
        ((_a = unref(data)) == null ? void 0 : _a.nowPlaying)
      ) {
        _push(`<div${ssrRenderAttrs(_attrs)}>`);
        _push(
          ssrRenderComponent(
            _component_SpotifyCurrentlyPlaying,
            { response: unref(data) },
            {
              default: withCtx((_, _push2, _parent2, _scopeId) => {
                if (_push2) {
...
_sfc_main$3.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add(
    'components/spotify/NowPlaying.vue',
  );
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(
        ...
        )}><p class="text-center font-ubuntu text-xs leading-5 text-neutral-500"> Powered by </p><!--[-->`,
      );
                ...
                if (_push2) {
                  ...
                  return [
                    createVNode(
                      'span',
                      { class: 'sr-only' },
                      toDisplayString(provider.display),
                      1,
                    ),
                    createVNode(
                      _component_Icon,
...
//# sourceMappingURL=default-36e21261.js.map
