...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  async setup(props) {
    ...
    const tags = {
      ...(mdc.components.prose && props.prose !== false
        ? proseComponentMap
        : {}),
      ...mdc.components.map,
      ...toRaw(
        ((_b = (_a = props.data) == null ? void 0 : _a.mdc) == null
          ? void 0
          : _b.components) || {},
      ),
      ...props.components,
    ...
    const contentKey = computed(() => {
      var _a2;
      const components = (
        ((_a2 = props.body) == null ? void 0 : _a2.children) || []
      )
        .map((n) => n.tag || n.type)
  ...
  render(ctx) {
    ...
    const component =
      tag !== false
        ? resolveVueComponent(
            tag ||
              ((_a = meta.component) == null ? void 0 : _a.name) ||
              meta.component ||
              'div',
          )
        : void 0;
    ...
    return component
      ...
      : (_c = childrenRendrer.default) == null
      ? void 0
      : _c.call(childrenRendrer);
  },
});
...
function renderBinding(node, h2, documentMeta, parentScope = {}) {
  ...
  const keys =
    (_a = node.props) == null
      ? void 0
      : _a.value.trim().split(splitter).filter(Boolean);
...
function renderSlots(node, h2, documentMeta, parentProps) {
  ...
  const slots = Object.entries(slotNodes).reduce(
    (slots2, [name, children2]) => {
      if (!children2.length) {
        return slots2;
      }
      slots2[name] = () => {
        const vNodes = children2.map((child) =>
          renderNode(child, h2, documentMeta, parentProps),
        );
...
const resolveVueComponent = (component) => {
  if (
    !htmlTags.includes(component) &&
    !(component == null ? void 0 : component.render)
  ) {
...
function evalInContext(code, context) {
  const result = code
    .split('.')
    .reduce((o, k) => (typeof o === 'object' ? o[k] : void 0), context);
...
function mergeTextNodes(nodes) {
  ...
  for (const node of nodes) {
    ...
    if (
      node.type === Text &&
      (previousNode == null ? void 0 : previousNode.type) === Text
    ) {
...
async function resolveContentComponents(body, meta) {
  ...
  await Promise.all(
    components.map(async (c) => {
      if (
        (c == null ? void 0 : c.render) ||
        (c == null ? void 0 : c.ssrRender) ||
        (c == null ? void 0 : c.__ssrInlineRender)
      ) {
        return;
      }
      ...
      if (
        (resolvedComponent == null
          ? void 0
          : resolvedComponent.__asyncLoader) &&
        !resolvedComponent.__asyncResolved
      ) {
...
function findMappedTag(node, tags) {
  ...
  if (
    !tag ||
    typeof ((_a = node.props) == null ? void 0 : _a.__ignoreMap) !== 'undefined'
  ) {
    return tag;
  }
...
_sfc_main$1.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add(
    'node_modules/@nuxtjs/mdc/dist/runtime/components/MDCRenderer.vue',
  );
...
//# sourceMappingURL=ContentRendererMarkdown-6b4feeaa.js.map
