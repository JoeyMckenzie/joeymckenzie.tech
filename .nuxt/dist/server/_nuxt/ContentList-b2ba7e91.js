...
const emptyNode = (slot, data) =>
  h(
    ...
    null,
    JSON.stringify(
      { message: 'You should use slots with <ContentList>', slot, data },
      null,
      2,
    ),
  );
    ...
    return h(_sfc_main$1, contentQueryProps, {
      ...
      default: (slots == null ? void 0 : slots.default)
        ? ({ data, refresh, isPartial }) =>
            slots.default({ list: data, refresh, isPartial, ...this.$attrs })
        : (bindings) => emptyNode('default', bindings.data),
      // Empty slot
      empty: (bindings) =>
        (slots == null ? void 0 : slots.empty)
          ? slots.empty(bindings)
          : emptyNode('default', bindings == null ? void 0 : bindings.data),
      // Not Found slot
      'not-found': (bindings) => {
        var _a;
        return (slots == null ? void 0 : slots['not-found'])
          ? (_a = slots == null ? void 0 : slots['not-found']) == null
            ? void 0
            : _a.call(slots, bindings)
          : emptyNode('not-found', bindings == null ? void 0 : bindings.data);
      },
    });
  },
});
...
//# sourceMappingURL=ContentList-b2ba7e91.js.map
