...
const ContentQuery = /* @__PURE__ */ defineComponent({
  ...
  async setup(props) {
    const { path, only, without, where, sort, limit, skip, locale, find } =
      toRefs(props);
    ...
    const resolveResult = (result) => {
      if (legacy) {
        ...
        return (result == null ? void 0 : result._id) || Array.isArray(result)
          ? result
          : result == null
          ? void 0
          : result.result;
  ...
  render(ctx) {
    ...
    if (props.find === 'one') {
      ...
      if (
        ...
        (data == null ? void 0 : data._type) === 'markdown' &&
        !((_a = data == null ? void 0 : data.body) == null
          ? void 0
          : _a.children.length)
      ) {
...
//# sourceMappingURL=ContentQuery-2a62b439.js.map
