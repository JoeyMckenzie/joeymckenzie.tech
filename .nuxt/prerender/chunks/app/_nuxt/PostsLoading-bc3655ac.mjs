...
import { useSSRContext, defineComponent, mergeProps, unref, withCtx, createVNode, createTextVNode, toDisplayString } from 'file:///Users/jmckenzie/projects/web/joey-mckenzie-tech/node_modules/vue/index.mjs';
import { ssrRenderAttrs, ssrRenderList, ssrRenderComponent, ssrInterpolate } from 'file:///Users/jmckenzie/projects/web/joey-mckenzie-tech/node_modules/vue/server-renderer/index.mjs';
...
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<article${ssrRenderAttrs(mergeProps({ class: "flex max-w-xl flex-col items-start transition duration-150 ease-in-out hover:-translate-y-1 hover:scale-105" }, _attrs))}><div class="flex items-center gap-x-4 text-xs">`);
...
//# sourceMappingURL=PostsLoading-bc3655ac.mjs.map
