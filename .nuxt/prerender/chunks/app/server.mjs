import { hasInjectionContext, getCurrentInstance, version, ref, watchEffect, watch, inject, shallowRef, toRef, onServerPrefetch, computed, unref, reactive, defineAsyncComponent, useSSRContext, defineComponent, withAsyncContext, withCtx, createVNode, createApp, effectScope, markRaw, isRef, isReactive, toRaw, nextTick, h, Suspense, Transition, provide, onErrorCaptured, resolveDynamicComponent, shallowReactive, isReadonly, getCurrentScope, onScopeDispose, mergeProps, toRefs, isShallow } from 'file:///Users/jmckenzie/projects/web/joey-mckenzie-tech/node_modules/vue/index.mjs';
import { $fetch as $fetch$1 } from 'file:///Users/jmckenzie/projects/web/joey-mckenzie-tech/node_modules/ofetch/dist/node.mjs';
import { createHooks } from 'file:///Users/jmckenzie/projects/web/joey-mckenzie-tech/node_modules/hookable/dist/index.mjs';
import { getContext } from 'file:///Users/jmckenzie/projects/web/joey-mckenzie-tech/node_modules/unctx/dist/index.mjs';
...
import { getActiveHead } from 'file:///Users/jmckenzie/projects/web/joey-mckenzie-tech/node_modules/unhead/dist/index.mjs';
import { defineHeadPlugin, composableNames, unpackMeta } from 'file:///Users/jmckenzie/projects/web/joey-mckenzie-tech/node_modules/@unhead/shared/dist/index.mjs';
import { useRoute as useRoute$1, RouterView, createMemoryHistory, createRouter, START_LOCATION } from 'file:///Users/jmckenzie/projects/web/joey-mckenzie-tech/node_modules/vue-router/dist/vue-router.node.mjs';
import { createError as createError$1, sanitizeStatusCode, getRequestHeader, setCookie, getCookie, deleteCookie } from 'file:///Users/jmckenzie/projects/web/joey-mckenzie-tech/node_modules/h3/dist/index.mjs';
import { withQuery, hasProtocol, parseURL, isScriptProtocol, joinURL, withBase, withLeadingSlash, withoutTrailingSlash } from 'file:///Users/jmckenzie/projects/web/joey-mckenzie-tech/node_modules/ufo/dist/index.mjs';
import { ssrRenderAttrs, ssrRenderComponent, ssrRenderSuspense, ssrRenderVNode } from 'file:///Users/jmckenzie/projects/web/joey-mckenzie-tech/node_modules/vue/server-renderer/index.mjs';
import { hash, isEqual } from 'file:///Users/jmckenzie/projects/web/joey-mckenzie-tech/node_modules/ohash/dist/index.mjs';
import { parse } from 'file:///Users/jmckenzie/projects/web/joey-mckenzie-tech/node_modules/cookie-es/dist/index.mjs';
...
const _routes = [
  ...
  },
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/_...slug_-06312b3b.mjs').then((m) => m.default || m)
  },
  {
    name: "blog",
    path: "/blog",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/index-f064a507.mjs').then((m) => m.default || m)
  },
  {
    name: "index",
    path: "/",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/index-4bd8f42c.mjs').then((m) => m.default || m)
  }
];
...
const LazyIcon = defineAsyncComponent(() => import('./_nuxt/Icon-c173e519.mjs').then((r) => r.default));
const LazyIconCSS = defineAsyncComponent(() => import('./_nuxt/IconCSS-f65c0bc7.mjs').then((r) => r.default));
...
const layouts = {
  default: () => import('./_nuxt/default-36e21261.mjs').then((m) => m.default || m)
};
