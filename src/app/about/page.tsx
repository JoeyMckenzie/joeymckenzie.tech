      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="prose mx-auto max-w-2xl lg:mx-0">
          ...
          <Paragraph>
            ...
            IBM, .NET, and most of the major web frontend frameworks you&apos;ll
            see folks arguing about over on{' '}
            <SimpleLink href="https://reddit.com/r/webdev">r/webdev</SimpleLink>
            .
          </Paragraph>
          <Paragraph>
            By day, I&apos;m a <InlineBold>Senior Software Engineer</InlineBold>{' '}
            working on mostly .NET technologies. In my spare time, I work
            primarily within the TypeScript and Rust ecosystems (I&apos;m even
            writing a{' '}
            <SimpleLink href="https://fullstackrust.netlify.app/">
              Rust web series!
            </SimpleLink>
            ), contributing to projects I find interesting and exploring new
            technologies. I like to write about things I come across in the wild
            (of software), design, frameworks, and language features among other
            things. If I find the time, you can catch any of my content on{' '}
            <SimpleLink href="https://www.youtube.com/channel/UCkdpN-mQSyJ_2XJMU1kQ5fA#">
              YouTube
            </SimpleLink>{' '}
            or streaming live on{' '}
            <SimpleLink href="https://twitch.tv/JoeTheDevMan">
              Twitch
            </SimpleLink>
            . Checkout my{' '}
            <Link
          ...
          <Paragraph>
            ...
            friends, walking our dog Moose, and sampling the latest installment
