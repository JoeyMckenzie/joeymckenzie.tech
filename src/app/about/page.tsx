    ...
    <>
      ...
      <div className="prose mx-auto flex max-w-2xl flex-col text-justify text-sm leading-8 text-neutral-400">
        ...
        <p>
          ...
          now finance. I enjoy building fast and efficient web services,
          exploring new technologies, and arguing with other developers about
        ...
        <p>
          ...
          software), design, frameworks, and language features among other
