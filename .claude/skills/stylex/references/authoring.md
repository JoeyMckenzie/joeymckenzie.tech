<!-- Vendored verbatim from https://stylexjs.com/docs/llm-resources (stylex-authoring.md).
     Re-download to update; hand edits are lost on the next sync. Repo-specific
     conventions live in ../SKILL.md and ./migration.md, not here. -->
