...
const appName = "joeymckenzie.tech";
createServer(
  (page) => createInertiaApp({
    ...
    resolve: (name) => resolvePageComponent(
      `./Pages/${name}.vue`,
      /* @__PURE__ */ Object.assign({ "./Pages/Blog/Index.vue": () => import("./assets/Index-t-srpbex.js"), "./Pages/Blog/Post.vue": () => import("./assets/Post-1iYbpqJh.js"), "./Pages/Index.vue": () => import("./assets/Index-DQAqeKaM.js"), "./Pages/Now.vue": () => import("./assets/Now-DBBCTMS6.js") })
    ),
