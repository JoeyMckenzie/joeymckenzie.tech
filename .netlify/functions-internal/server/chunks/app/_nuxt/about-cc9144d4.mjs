import { _ as _sfc_main$2 } from './SectionHeader-2f2bda11.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_SectionHeader, { title: "Bio" }, null, _parent));
...
//# sourceMappingURL=about-cc9144d4.mjs.map
