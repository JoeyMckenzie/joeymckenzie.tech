import { _ as _sfc_main$5 } from './SectionHeader-2f2bda11.mjs';
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  ...
  _push(`<div${ssrRenderAttrs(mergeProps({ class: "flex flex-row items-center gap-x-4" }, _attrs))}><div class="prose mx-auto inline-flex max-w-2xl flex-col text-sm leading-6 text-neutral-400"><p class="mt-6 text-justify"> Hi, I&#39;m Joey. I&#39;m a `);
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_NuxtLink, mergeProps({
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<span class="sr-only"${_scopeId}>${ssrInterpolate(_ctx.name)}</span>`);
            ...
            return [
              createVNode("span", { class: "sr-only" }, toDisplayString(_ctx.name), 1),
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_HomeIntroSection, null, null, _parent));
...
//# sourceMappingURL=index-a7e581c9.mjs.map
