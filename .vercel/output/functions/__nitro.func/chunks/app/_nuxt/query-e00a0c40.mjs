import { H as withLeadingSlash, k as joinURL, A as withoutTrailingSlash, I as withBase, C as hash } from '../../nitro/vercel.mjs';
...
const createQueryFetch = () => async (query) => {
  ...
  if (shouldUseClientDB()) {
    const db = await import('./client-db-cdd2ac50.mjs').then((m) => m.useContentDatabase());
...
//# sourceMappingURL=query-e00a0c40.mjs.map
