import { _ as _sfc_main$4 } from './FormattedDate-62af8e69.mjs';
import { useSSRContext, ref, computed, defineComponent, withAsyncContext, mergeProps, unref, withCtx, createVNode, createTextVNode, toDisplayString } from 'vue';
...
import { q as queryContent } from './query-e00a0c40.mjs';
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({
        "v-if": props.viewCount > 0,
        class: "font-medium text-neutral-400"
      }, _attrs))}>${ssrInterpolate(props.viewCount)} views </div>`);
    };
  }
});
...
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_FormattedDate, {
        date: props.pubDate
      }, null, _parent));
      ...
      _push(ssrRenderComponent(_component_BlogPostViewCount, {
...
const usePostStore = defineStore("counter", () => {
  const posts = ref([]);
  const latestsPosts = computed(() => posts.value.slice(0, 3));
  async function fetchPosts() {
    const [{ data: viewCounts2 }, { data: blogPosts }] = await Promise.all([
      useFetch("/api/blogs", "$alnc7jqzt0"),
      useAsyncData(
        "blogs",
        () => queryContent("blog").only(["_path", "category", "description", "pubDate", "title"]).find()
      )
    ]);
    const orderedPosts = (blogPosts == null ? void 0 : blogPosts.value) ? blogPosts.value.sort(
      ...
      (p) => {
        ...
        return {
          ...
          title: p.title,
          viewCount: (_a2 = (_c = (_b = (_a = viewCounts2.value) == null ? void 0 : _a.viewCounts) == null ? void 0 : _b.find(
            (vc) => {
              var _a22;
              return (_a22 = p._path) == null ? void 0 : _a22.includes(vc.slug);
            }
          )) == null ? void 0 : _c.count) != null ? _a2 : 0
        };
      }
    ) : [];
...
//# sourceMappingURL=PostsLoading-0257d502.mjs.map
