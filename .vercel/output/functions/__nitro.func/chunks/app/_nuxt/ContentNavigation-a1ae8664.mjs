...
import { u as useContentDisabled, q as queryContent, w as withContentBase, e as encodeQueryParams, a as addPrerenderPath, s as shouldUseClientDB, j as jsonStringify } from './query-e00a0c40.mjs';
...
const fetchContentNavigation = async (queryBuilder) => {
  ...
  if (shouldUseClientDB()) {
    const generateNavigation = await import('./client-db-cdd2ac50.mjs').then((m) => m.generateNavigation);
...
//# sourceMappingURL=ContentNavigation-a1ae8664.mjs.map
