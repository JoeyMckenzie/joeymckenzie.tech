...
const _inlineRuntimeConfig = {
  "app": {
    "baseURL": "/",
    "buildId": "84519156-f9a4-4df1-9d6f-313962aba809",
...
const _assets = {
  ["nuxt-og-image:fonts:Inter-400.ttf.base64"]: {
    ...
    meta: {"type":"text/plain; charset=utf-8","etag":"\"652cc-qEeSD1DXCSV8gPP2rnBA6ePGdZ4\"","mtime":"2024-06-19T18:29:02.325Z"}
  },
  ["nuxt-og-image:fonts:Inter-700.ttf.base64"]: {
    import: () => import('./raw/Inter-700.ttf.mjs').then(r => r.default || r),
    meta: {"type":"text/plain; charset=utf-8","etag":"\"674f0-FZReUXHhPTnY0HmYVn2iPpKm9ds\"","mtime":"2024-06-19T18:29:02.325Z"}
  }
};
...
const _3JB6cANo8H = defineNitroPlugin(async (nitroApp) => {
...
const _TRbY2t09H5 = defineNitroPlugin(async (nitroApp) => {
...
const _NFuPIHjse6 = defineNitroPlugin(async (nitro) => {
  return;
});
...
const _qhWIZzk0jd = (function(nitro) {
...
const _5QGLBr = defineEventHandler(async (e) => {
...
const _SBZne7 = defineEventHandler(async (e) => {
...
const _njK5Uj = defineEventHandler(async (e) => {
...
const _28j6hk = defineEventHandler(async (e) => {
...
const _bvFbMc = defineEventHandler(async (e) => {
...
const _lK97wW = defineCachedEventHandler(async (ctx) => {
...
const _lazy_GRbtgA = () => import('./routes/renderer.mjs').then(function (n) { return n.r; });
const _lazy_UTwBeJ = () => import('./routes/__og-image__/font/font.mjs');
const _lazy_OFozwC = () => import('./routes/__og-image__/image/image.mjs').then(function (n) { return n.i; });

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_GRbtgA, lazy: true, middleware: false, method: undefined },
  { route: '', handler: _5QGLBr, lazy: false, middleware: true, method: undefined },
  { route: '/robots.txt', handler: _SBZne7, lazy: false, middleware: false, method: undefined },
  { route: '', handler: _njK5Uj, lazy: false, middleware: false, method: undefined },
  { route: '/__sitemap__/style.xsl', handler: _28j6hk, lazy: false, middleware: false, method: undefined },
  { route: '/sitemap.xml', handler: _bvFbMc, lazy: false, middleware: false, method: undefined },
  { route: '/__og-image__/font/**', handler: _lazy_UTwBeJ, lazy: true, middleware: false, method: undefined },
  { route: '/__og-image__/image/**', handler: _lazy_OFozwC, lazy: true, middleware: false, method: undefined },
  { route: '/api/_nuxt_icon/:collection', handler: _lK97wW, lazy: false, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_GRbtgA, lazy: true, middleware: false, method: undefined }
];
...
export { createStorage as A, withQuery as B, withoutLeadingSlash as C, normalizeKey$1 as D, prefixStorage as E, withTrailingSlash as F, useStorage as G, handleCacheHeaders as H, setHeaders as I, setHeader as J, H3Error as K, createHooks as L, sanitizeStatusCode as M, useNitroOrigin as N, withBase as O, vercel as P, send as a, setResponseStatus as b, setResponseHeaders as c, useRuntimeConfig as d, eventHandler as e, getQuery as f, getResponseStatus as g, createError$1 as h, getRouteRules as i, joinRelativeURL as j, hash as k, getResponseStatusText as l, destr as m, defineEventHandler as n, proxyRequest as o, parseURL as p, sendRedirect as q, readBody as r, setResponseHeader as s, toRouteMatcher as t, useNitroApp as u, createRouter$1 as v, withoutTrailingSlash as w, defu as x, withoutBase as y, defineDriver as z };
