...
const BlogLayout: FC = ({ children }) => {
  ...
  }, [route, frontMatters, setNextBlog, setPreviousBlog]);

  return (
    <div className="relative my-24 overflow-hidden">
      <div className="relative px-4 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-prose text-lg">
          <div className="prose prose-lg prose-stone mx-auto mt-6 text-gray-500 prose-h1:text-center prose-img:mx-auto prose-img:max-w-xl prose-img:rounded-sm dark:prose-invert dark:text-gray-300">
            {children}
          </div>
