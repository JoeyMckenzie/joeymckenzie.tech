        ...
        <div className="text-center sm:tracking-tight">
          ...
          <div className="text-gray-900 dark:text-gray-400">
            ...
            <p className="block max-w-sm pt-2">
              Breaking production environments professionally since 2016,
              creating content for other developers and engineers, and building
              things for the web that go really, really fast.
            </p>
          </div>
        </div>
      </div>
