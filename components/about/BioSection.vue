<template>
  ...
  >
    <p class="mt-6">
      ...
      of the major web frontend frameworks you&apos;ll see folks arguing about
      over on
      <a
    ...
    <p>
      ...
      in healthcare, insurance, SaaS startups, manufacturing, and now finance. I
      enjoy building fast and efficient web services, exploring new
    ...
    <p>
      ...
      <a
        ...
        >Twitch</a
      >. Checkout my
      <a href="/blog" class="text-indigo-400 hover:text-indigo-500"> blog</a>
    ...
    <p>
      ...
      friends, and sampling the latest installment of adult beverages at my
      local breweries.
    </p>
  </div>
</template>
