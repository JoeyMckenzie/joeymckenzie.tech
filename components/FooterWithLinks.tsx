...
import { SiNextdotjs, SiVercel, SiTwitch } from 'react-icons/si';
...
const FooterWithLinks: VFC = () => (
  <footer className="mx-auto max-w-7xl overflow-hidden py-12 px-4 sm:px-6 lg:px-8">
    ...
    {process.env.NEXT_PUBLIC_VERCEL_GIT_COMMIT_SHA ? (
      <span className="flex justify-center pt-4 text-sm text-gray-900 dark:text-gray-500">
        version:{' '}
