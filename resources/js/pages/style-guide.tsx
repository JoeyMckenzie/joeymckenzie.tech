...
export default function StyleGuide() {
                ...
                <div className="mx-auto max-w-3xl px-6 py-16">
                    ...
                    <header>
                        ...
                        <p className="mt-4 max-w-xl text-subtle">
                            ...
                            colour, and components this whole site is built
                            from. A beautifully typeset essay read at night,
                            with a craftsman&rsquo;s fingerprint at the bottom
                            of the screen.
                        </p>
                    </header>
                    ...
                    <section className="mt-16">
                        ...
                        <article className="prose-nocturne mt-6">
                            ...
                            <p>
                                ...
                                subscriber since 2016 &mdash; but something had
                                to give, and it turned out to be my{' '}
                                <a href="#">entire editor</a>.
                            </p>
                            <blockquote>
                                We have Herd at home. The Herd at home: a pile
                                of nix expressions and a suspicious amount of
                                confidence.
                            </blockquote>
                            <p>
                                The trick is to keep the good parts &mdash; a
                                fast <code>artisan</code> loop, real
                                type-checking &mdash; while dropping the
                                ceremony. Here&rsquo;s the shape of it:
                            </p>
    ...
    println!("{greeting}");
                            ...
                            <ul>
                                <li>
                                    Terminal-native, but dressed for company.
                                </li>
                    ...
                    <section className="mt-16">
                        ...
                        <div className="mt-4 flex flex-wrap items-center gap-x-3 gap-y-1 rounded-lg border border-hairline bg-panel px-3 py-2 font-mono text-xs text-subtle">
                            ...
                            <span>↑ 1.2k</span>
                            <span className="nocturne-cursor text-prose">
                                ▮
                            </span>
                        </div>
                    </section>
                    ...
                    {/* Colophon footer */}
                    <footer className="mt-20 border-t border-hairline pt-6 font-mono text-xs text-subtle">
