                ...
                <div className="mx-auto max-w-3xl px-6 py-16">
                    <header>
                        ...
                        <p className="mt-4 max-w-xl text-subtle">
                            Laravel, Rust, .NET, and whatever tooling rabbit
                            hole has me this month. Mostly code, occasionally
                            opinions.
                        </p>
                    </header>
                    ...
                    {/* Statusline */}
                    <footer className="mt-16 flex flex-wrap items-center gap-x-3 gap-y-1 rounded-lg border border-hairline bg-panel px-3 py-2 font-mono text-xs text-subtle">
                        <span className="rounded bg-iris/15 px-1.5 py-0.5 font-medium text-iris">
                            NORMAL
                        </span>
                        <span>~/blog</span>
                        {filters.tag && (
                            <span className="text-iris">{filters.tag}</span>
                        )}
