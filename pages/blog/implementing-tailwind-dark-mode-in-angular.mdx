---
previewImageUrl: /assets/blog/tailwind-dark-mode/tailwind-dark-mode-meme.jpg
previewImageAlt: Angular Tailwind dark mode blog preview image
domains:
  - Angular
  - Tailwind
title: Implementing dark mode in Angular with Tailwind
subtitle: Because light mode is so 2018.
...
<div class="min-h-screen flex flex-col justify-center items-center gap-y-4">
  <button
    ...
    id="dark-mode-toggle"
    class="bg-blue-500 dark:bg-blue-800 hover:bg-blue-700 dark:hover:bg-blue-900 text-white dark:text-blue-400 font-bold py-2 px-4 rounded"
  >
    Toggle
  </button>
...
[Tailwind dark mode toggle example](/assets/blog/tailwind-dark-mode/dark-mode-toggle.webm)
