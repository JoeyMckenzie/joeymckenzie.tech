---
previewImageUrl: /assets/blog/tailwind-ngrx-modal/off_the_shelf_modal.jpg
previewImageAlt: 'Off the shelf modal meme'
domains:
  - Angular
  - NgRx
  - Tailwind
title: 'Build a Tailwind modal with Angular and NgRx'
subtitle: "Out-of-the-box modals are nice, but often times inflexible and can bring a lot of unnecessary code into a project for something as simple as displaying a message. Let's use Tailwind to build our very own state-based modal instead!"
...
published: true
timeToRead: 10
slug: build-a-tailwind-modal-with-ngrx
---
...
[Our full Ngrx-based Tailwind modal](/assets/blog/tailwind-ngrx-modal/screen_grab.webm)
