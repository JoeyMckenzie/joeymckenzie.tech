---
previewImageUrl: /assets/blog/blazor-basics-series/javascript_meme.png
previewImageAlt: 'Blazor .NET'
domains:
  - Blazor
title: 'Blazor basics - calling external APIs with typed HTTP clients'
subtitle: "Move over Javascript, there's a new sheriff in town (not really, we still love you, JS)."
...
![Browser_server_model](/assets/blog/blazor-basics-series/http_request_flow.png)
...
![File_new_project](/assets/blog/blazor-basics-series/file_new_project.png)

Select `Blazor App` from the dialog that appears, and we'll setup our project metadata.

![project_name](/assets/blog/blazor-basics-series/project_name.png)
...
![blazor_hosting_model](/assets/blog/blazor-basics-series/blazor_hosting_model.png)
...
![landing_page](/assets/blog/blazor-basics-series/initial_landing_page.png)

Now, if we navigate to `https://localhost:5001/projects`, we'll see our newly added page:

![projects_page](/assets/blog/blazor-basics-series/projects_page.png)
...
![projects_page_with_nav](/assets/blog/blazor-basics-series/projects_page_with_nav.png)
...
![event_handlers_in_action](/assets/blog/blazor-basics-series/event_handlers_in_action.png)
...
![updated_projects_on_load](/assets/blog/blazor-basics-series/updated_projects_on_load.png)
...
![first_project](/assets/blog/blazor-basics-series/first_project_after_load.png)
...
![initial_repos_load](/assets/blog/blazor-basics-series/initial_repos_load.png)
...
![commits_response](/assets/blog/blazor-basics-series/commits_response.png)
