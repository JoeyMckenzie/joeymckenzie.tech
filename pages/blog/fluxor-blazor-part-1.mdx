---
previewImageUrl: https://imgs.xkcd.com/comics/unreachable_state.png
previewImageAlt: Blazor state management with Fluxor
domains: [Blazor, Fluxor]
title: State Management with Blazor using Fluxor (Part 1)
subtitle: Manage state in your Blazor applications using the tried-and-true flux pattern with Fluxor.
...
published: true
timeToRead: 15
slug: fluxor-state-management-with-blazor-part-1
---
...
![Flux_flow](/assets/blog/state-management-with-blazor-using-fluxor/part-1/flux-in-a-nutshell.png)
...
![facade](/assets/blog/state-management-with-blazor-using-fluxor/part-1/facade_redirection.png)
