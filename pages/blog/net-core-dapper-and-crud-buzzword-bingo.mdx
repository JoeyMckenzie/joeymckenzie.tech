---
previewImageUrl: /assets/blog/net-core-dapper-and-crud-series/part-1/beer-background-dappery.jpg
previewImageAlt: Dapper and .NET Core
domains: [Dapper, .NET Core]
title: Clean architecture, Dapper, MediatR, and buzzword bingo (part 1)
subtitle: Build an API using Dapper, MediatR, and clean architecture principles with the help of beer.
...
![Project](/assets/blog/net-core-dapper-and-crud-series/part-1/project-setup.png)
...
![Project_thus_far](/assets/blog/net-core-dapper-and-crud-series/part-1/project-dtos-in-place.png)
...
![Domain_layer_finished](/assets/blog/net-core-dapper-and-crud-series/part-1/finished-domain-layer.png)
